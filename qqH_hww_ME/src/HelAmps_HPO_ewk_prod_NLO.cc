    ...
    & vertex)
{
  ...
  P2[2] = V2[1].imag(); 
  P2[3] = V2[0].imag(); 
  TMP5 = (-1.) * (P1[0] * (P2[1] * (V2[4] * V1[5] - V2[5] * V1[4]) + (P2[2] *
      (V2[5] * V1[3] - V2[3] * V1[5]) + P2[3] * (V2[3] * V1[4] - V2[4] *
      V1[3]))) + (P1[1] * (P2[0] * (V2[5] * V1[4] - V2[4] * V1[5]) + (P2[2] *
      (V2[2] * V1[5] - V2[5] * V1[2]) + P2[3] * (V2[4] * V1[2] - V2[2] *
      V1[4]))) + (P1[2] * (P2[0] * (V2[3] * V1[5] - V2[5] * V1[3]) + (P2[1] *
    ...
    std::complex<double> V3[])
{
  ...
  denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  V3[2] = denom * - cI * S4[2] * (F1[4] * F2[2] + F1[5] * F2[3] - P3[0] * OM3 *
      TMP3);
  V3[3] = denom * - cI * S4[2] * (F1[4] * F2[3] + F1[5] * F2[2] - P3[1] * OM3 *
      TMP3);
  V3[4] = denom * cI * S4[2] * (P3[2] * OM3 * TMP3 - cI * (F1[4] * F2[3]) + cI
      * (F1[5] * F2[2]));
  V3[5] = denom * cI * S4[2] * (F1[5] * F2[3] + P3[3] * OM3 * TMP3 - F1[4] *
      F2[2]);
}
    ...
    std::complex<double> COUP, double M3, double W3, std::complex<double> V3[])
{
  ...
  denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  V3[2] = denom * (-cI) * (F1[4] * F2[2] + F1[5] * F2[3] - P3[0] * OM3 * TMP3); 
  V3[3] = denom * (-cI) * (F1[4] * F2[3] + F1[5] * F2[2] - P3[1] * OM3 * TMP3); 
  V3[4] = denom * (-cI) * (-cI * (F1[5] * F2[2]) + cI * (F1[4] * F2[3]) - P3[2]
      * OM3 * TMP3);
  V3[5] = denom * (-cI) * (F1[4] * F2[2] - F1[5] * F2[3] - P3[3] * OM3 * TMP3); 
}
    ...
    std::complex<double> V3[])
{
  ...
  denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  V3[2] = denom * - cI * S4[2] * (F1[2] * F2[4] + F1[3] * F2[5] - P3[0] * OM3 *
      TMP1);
  V3[3] = denom * cI * S4[2] * (F1[2] * F2[5] + F1[3] * F2[4] + P3[1] * OM3 *
      TMP1);
  V3[4] = denom * cI * S4[2] * (P3[2] * OM3 * TMP1 - cI * (F1[3] * F2[4]) + cI
      * (F1[2] * F2[5]));
  V3[5] = denom * cI * S4[2] * (F1[2] * F2[4] + P3[3] * OM3 * TMP1 - F1[3] *
      F2[5]);
}
    ...
    COUP2, double M3, double W3, std::complex<double> V3[])
{
  ...
  int i; 
  std::complex<double> Vtmp[6]; 
  FFVS1_3(F1, F2, S4, COUP1, M3, W3, V3); 
  FFVS2_3(F1, F2, S4, COUP2, M3, W3, Vtmp); 
  i = 2; 
  while (i < 6)
  {
    V3[i] = V3[i] + Vtmp[i]; 
    ...
    & vertex)
{
  ...
  TMP10 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  vertex = COUP * S3[2] * (-cI * (TMP7 * TMP8) + cI * (TMP9 * TMP10)); 
}
...
}  // end namespace $(namespace)s_HPO_ewk_prod_NLO
