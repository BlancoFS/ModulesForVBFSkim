...
P1_Sigma_sm_gg_zuux::P1_Sigma_sm_gg_zuux(const ParameterSet& configuration) 
{
  ...
  mME.push_back(std::ref(params->ZERO)); 
  mME.push_back(std::ref(params->mdl_MZ)); 
  mME.push_back(std::ref(params->ZERO)); 
  mME.push_back(std::ref(params->ZERO)); 

  mapFinalStates[{23, 4, -4}] = 
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_uux_zccx, 
      true, 
      {
  ...
  mapFinalStates[{23, 1, -2}] = 
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_dux_zdux, 
      true, 
      {
  ...
  mapFinalStates[{23, 21, 21}] = 
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_uux_zgg, 
      true, 
      {
        std::make_pair(2, -2), std::make_pair(4, -4)
      }, 
    ...
    , 
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_ddx_zgg, 
      true, 
      {
  ...
  mapFinalStates[{23, -2, -4}] = 
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_uxcx_zuxcx, 
      true, 
      {
        std::make_pair(-2, -4)
      }, 
  ...
  mapFinalStates[{23, 21, -2}] = 
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_gux_zgux, 
      true, 
      {
  ...
  mapFinalStates[{23, 2, 1}] = 
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_ud_zud, 
      true, 
      {
  ...
  mapFinalStates[{23, -1, -1}] = 
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_dxdx_zdxdx, 
      false, 
      {
        std::make_pair(-1, -1), std::make_pair(-3, -3)
      }, 
  ...
  mapFinalStates[{23, -2, -2}] = 
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_uxux_zuxux, 
      false, 
      {
        std::make_pair(-2, -2), std::make_pair(-4, -4)
      }, 
  ...
  mapFinalStates[{23, 21, 1}] = 
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_gd_zgd, 
      true, 
      {
  ...
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_gg_zuux, 
      false, 
      {
    ...
    , 
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_uux_zuux, 
      true, 
      {
        std::make_pair(2, -2), std::make_pair(4, -4)
      }, 
    ...
    , 
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_ddx_zuux, 
      true, 
      {
  ...
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_ucx_zucx, 
      true, 
      {
  ...
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_uxdx_zuxdx, 
      true, 
      {
        std::make_pair(-2, -1), std::make_pair(-2, -3), std::make_pair(-4, -1),
            std::make_pair(-4, -3)
  ...
  mapFinalStates[{23, 1, -3}] = 
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_dsx_zdsx, 
      true, 
      {
  ...
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_dd_zdd, 
      false, 
      {
        std::make_pair(1, 1), std::make_pair(3, 3)
      }, 
  ...
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_gg_zddx, 
      false, 
      {
        std::make_pair(21, 21), std::make_pair(21, 21)
      }, 
    ...
    , 
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_ddx_zddx, 
      true, 
      {
        std::make_pair(1, -1), std::make_pair(3, -3)
      }, 
    ...
    , 
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_uux_zddx, 
      true, 
      {
  ...
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_ds_zds, 
      true, 
      {
        std::make_pair(1, 3)
      }, 
  ...
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_uu_zuu, 
      false, 
      {
        std::make_pair(2, 2), std::make_pair(4, 4)
      }, 
  ...
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_uc_zuc, 
      true, 
      {
        std::make_pair(2, 4)
      }, 
  ...
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_dxsx_zdxsx, 
      true, 
      {
        std::make_pair(-1, -3)
      }, 
  ...
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_udx_zudx, 
      true, 
      {
        std::make_pair(2, -1), std::make_pair(2, -3), std::make_pair(4, -1),
            std::make_pair(4, -3)
  ...
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_gdx_zgdx, 
      true, 
      {
        std::make_pair(21, -1), std::make_pair(21, -3)
      }, 
  ...
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_gu_zgu, 
      true, 
      {
        std::make_pair(21, 2), std::make_pair(21, 4)
      }, 
  ...
  mapFinalStates[{23, 3, -3}] = 
  {
    {
      &P1_Sigma_sm_gg_zuux::matrix_1_ddx_zssx, 
      true, 
      {
        std::make_pair(1, -1), std::make_pair(3, -3)
      }, 
...
void P1_Sigma_sm_gg_zuux::resetHelicities() 
{
...
std::map < std::pair < int, int > , double > P1_Sigma_sm_gg_zuux::compute(const
...
void P1_Sigma_sm_gg_zuux::calculate_wavefunctions(const int perm[], const int
    hel[])
{
  ...
  FFV2_5_1(w[3], w[2], params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[6]);
  FFV2_5_2(w[4], w[2], params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[7]);
  ...
  FFV2_3_1(w[3], w[2], -params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[12]);
  FFV2_3_2(w[4], w[2], -params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[13]);
  ...
  FFV2_5_1(w[16], w[2], params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[18]);
  FFV2_5_2(w[14], w[2], params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[19]);
  ...
  FFV2_3_1(w[16], w[2], -params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[24]);
  FFV2_3_2(w[14], w[2], -params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[25]);
  oxxxxx(&momenta[perm[1]][0], mME[1], hel[1], -1, w[26]); 
  FFV2_5_1(w[26], w[2], params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[27]);
  ...
  FFV2_3_1(w[26], w[2], -params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[31]);
  ixxxxx(&momenta[perm[0]][0], mME[0], hel[0], +1, w[32]); 
  FFV2_5_2(w[32], w[2], params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[33]);
  ...
  FFV2_3_2(w[32], w[2], -params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[46]);
  oxxxxx(&momenta[perm[0]][0], mME[0], hel[0], -1, w[47]); 
  ixxxxx(&momenta[perm[3]][0], mME[3], hel[3], -1, w[48]); 
  FFV2_5_2(w[48], w[2], params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[49]);
  ...
  FFV2_5_1(w[47], w[2], params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[53]);
  FFV2_3_2(w[48], w[2], -params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[54]);
  FFV2_3_1(w[47], w[2], -params->GC_51, params->GC_58, params->ZERO,
      params->ZERO, w[55]);
  ...
  FFV2_5_0(w[9], w[8], w[2], params->GC_51, params->GC_58, amp[2]); 
  FFV1_0(w[7], w[8], w[1], params->GC_11, amp[3]); 
  FFV2_5_0(w[10], w[11], w[2], params->GC_51, params->GC_58, amp[4]); 
  ...
  FFV2_3_0(w[9], w[8], w[2], -params->GC_51, params->GC_58, amp[10]); 
  FFV1_0(w[13], w[8], w[1], params->GC_11, amp[11]); 
  FFV2_3_0(w[10], w[11], w[2], -params->GC_51, params->GC_58, amp[12]); 
  ...
  FFV2_5_0(w[21], w[20], w[2], params->GC_51, params->GC_58, amp[18]); 
  FFV1_0(w[19], w[20], w[15], params->GC_11, amp[19]); 
  FFV2_5_0(w[22], w[23], w[2], params->GC_51, params->GC_58, amp[20]); 
  ...
  FFV2_3_0(w[21], w[20], w[2], -params->GC_51, params->GC_58, amp[26]); 
  FFV1_0(w[25], w[20], w[15], params->GC_11, amp[27]); 
  FFV2_3_0(w[22], w[23], w[2], -params->GC_51, params->GC_58, amp[28]); 
  ...
  FFV2_5_0(w[29], w[28], w[2], params->GC_51, params->GC_58, amp[34]); 
  FFV1_0(w[7], w[28], w[15], params->GC_11, amp[35]); 
  FFV2_5_0(w[10], w[30], w[2], params->GC_51, params->GC_58, amp[36]); 
  ...
  FFV2_3_0(w[29], w[28], w[2], -params->GC_51, params->GC_58, amp[42]); 
  FFV1_0(w[13], w[28], w[15], params->GC_11, amp[43]); 
  FFV2_3_0(w[10], w[30], w[2], -params->GC_51, params->GC_58, amp[44]); 
  ...
  FFV2_5_0(w[40], w[30], w[2], params->GC_51, params->GC_58, amp[58]); 
  FFV1_0(w[33], w[30], w[38], params->GC_11, amp[59]); 
  FFV2_5_0(w[41], w[42], w[2], params->GC_51, params->GC_58, amp[60]); 
  ...
  FFV2_3_0(w[40], w[30], w[2], -params->GC_51, params->GC_58, amp[82]); 
  FFV1_0(w[46], w[30], w[38], params->GC_11, amp[83]); 
  FFV2_3_0(w[41], w[42], w[2], -params->GC_51, params->GC_58, amp[84]); 
...
double P1_Sigma_sm_gg_zuux::matrix_1_gg_zuux() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_gg_zddx() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_gu_zgu() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_gd_zgd() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_gux_zgux() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_gdx_zgdx() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_uu_zuu() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_uux_zgg() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_uux_zuux() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_dd_zdd() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_ddx_zgg() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_ddx_zddx() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_uxux_zuxux() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_dxdx_zdxdx() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_uc_zuc() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_ud_zud() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_uux_zccx() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_uux_zddx() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_ucx_zucx() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_udx_zudx() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_ds_zds() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_dux_zdux() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_ddx_zuux() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_ddx_zssx() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_dsx_zdsx() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_uxcx_zuxcx() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_uxdx_zuxdx() 
{
...
double P1_Sigma_sm_gg_zuux::matrix_1_dxsx_zdxsx() 
{
...
REGISTER_MATRIX_ELEMENT("DY_ME_sm_P1_Sigma_sm_gg_zuux",
    DY_ME_sm::P1_Sigma_sm_gg_zuux);
